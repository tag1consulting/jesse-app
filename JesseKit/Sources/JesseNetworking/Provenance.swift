...
public struct JesseProvenance: Decodable, Equatable, Sendable {
...
public struct JesseProvenanceFlags: Decodable, Equatable, Sendable {
    public let hostedVerify: Bool
    public let verifyQueued: Bool
    public let citationsUnverified: Bool
    public init(hostedVerify: Bool, verifyQueued: Bool, citationsUnverified: Bool) {
        self.hostedVerify = hostedVerify
        self.verifyQueued = verifyQueued
        self.citationsUnverified = citationsUnverified
    }
    enum CodingKeys: String, CodingKey {
...
extension JesseProvenance {
    ...
    public static func from(json: String?) -> JesseProvenance? {
...
public let citationsUnverifiedWarning =
...
extension JesseProvenance {
    ...
    public enum Kind: Sendable { case hosted, local, emergency, warning }

    public var routeKind: Kind {
    ...
    public var isWarning: Bool { flags.citationsUnverified }
